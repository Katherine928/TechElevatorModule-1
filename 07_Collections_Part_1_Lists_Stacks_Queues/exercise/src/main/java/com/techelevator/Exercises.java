	...
	public List<Integer> interleaveLists(List<Integer> listOne, List<Integer> listTwo) {
		...
		if (listOne.size() == listTwo.size()) {
			for (int i = 0; i < listOne.size(); i++) {
				rec.add(listOne.get(index));
				rec.add(listTwo.get(index));
				index += 1;
			}
			...
			for (int i = listOne.size() * 2; i < listOne.size() + listTwo.size(); i++) {
				rec.add(i,listTwo.get(i-listOne.size()));
			}
		} else {
			...
			for (int i = listTwo.size() * 2; i < listOne.size() + listTwo.size(); i++) {
				rec.add(i,listOne.get(i-listTwo.size()));
			}
		}
